   ...
   public Calculator()
  {
     super("Calulator");
      ...
      for(int i=0;i<=9;i++)
      {
        ...
        b[i].setForeground(Color.DARK_GRAY);
        b[i].setBackground(new Color(255, 128, 64));
      }
      b10=new JButton("+");
      b10.setForeground(Color.DARK_GRAY);
      b10.setBackground(new Color(255, 128, 64));
      p.add(b10);
      b10.addActionListener(this);

      b11=new JButton("-");
      b11.setForeground(Color.DARK_GRAY);
      b11.setBackground(new Color(255, 128, 64));
      p.add(b11);
      b11.addActionListener(this);

      b12=new JButton("*");
      b12.setForeground(Color.DARK_GRAY);
      b12.setBackground(new Color(255, 128, 64));
      p.add(b12);
      b12.addActionListener(this);

      b13=new JButton("/");
      b13.setForeground(Color.DARK_GRAY);
      b13.setBackground(new Color(255, 128, 64));
      p.add(b13);
      b13.addActionListener(this);
 
      b14=new JButton("=");
      b14.setForeground(Color.DARK_GRAY);
      b14.setBackground(new Color(255, 128, 64));
      p.add(b14);
      b14.addActionListener(this);

      b15=new JButton("C");
      b15.setForeground(Color.DARK_GRAY);
      b15.setBackground(new Color(255, 128, 64));
      p.add(b15);
